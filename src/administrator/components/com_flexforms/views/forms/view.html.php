 ...
 * @since  1.6
 */
class FlexformsViewForms extends JViewLegacy
{
    protected $items;
    ...
    public function display($tpl = null)
    {
        ...
        FlexformsHelper::addSubmenu('forms');
    ...
    protected function addToolbar()
    {
        ...
        {
            JToolBarHelper::preferences('com_flexforms');
        }

        // Set sidebar action - New in 3.0
        JHtmlSidebar::setAction('index.php?option=com_flexforms&view=forms');
    }
    ...
    protected function getSortFields()
    {
        return array(
            ...
            'a.`title`' => JText::_('COM_FLEXFORMS_FORMS_FIELD_TITLE'),
